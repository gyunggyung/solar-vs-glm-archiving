# 본 내용은 제 개인적인 의견이 아니며, 현재는 삭제된 sionic-ai/solar-vs-glm 리포지토리의 아카이빙을 목적으로 합니다. 이 문구 이외에는 초기 원문 그대로이며, 원본이 삭제되기 전 발생한 2번의 커밋 내용은 반영되지 않았습니다. 해당 포크는 해당 리포지토리가 공개된 직후 원본이 삭제될 것을 예상하여 즉시 진행한 것입니다.
